...
func _ready():
	...
	load_questions() #carica le domande all'avvio della scena
...
func load_questions():
	#carica il file colazione.json
	var file = FileAccess.open("res://Json_files/Colazione.json", FileAccess.READ)
	if file == null:
